...
int bitReverse(int x) {
     ...
     *
     * Supoose v is a 32-bit word to reverse bit order
     *
     ...
     * 5. swap 2-byte long pairs
     *    v = ((v >> 16) & 0x0000FFFF) | ((v & 0x0000FFFF) << 16);
     *
     * Walk-through with an example v = 0x89ABCDEF
     *
     ...
     * 1. swap odd and even bits
     *    v >> 1
     *    1100 0100 1101 0101 1110 0110 1111 0111 (move odd bits to even positions)
     *    0x55555555
     *    0101 0101 0101 0101 0101 0101 0101 0101 (mask to clear odd positions)
     *    (v >> 1) & 0x55555555
     *    0100 0100 0101 0101 0100 0100 0101 0101 (move odd bits to even positions, clear odd positions)
     *    v & 0x55555555
     *    0000 0001 0000 0001 0100 0101 0100 0101 (mask to clear odd positions)
     *    (v & 0x55555555) << 1
     *    0000 0010 0000 0010 1000 1010 1000 1010 (move even bits to odd positions, clear even positions)
     *    (v >> 1) & 0x55555555 | (v & 0x55555555) << 1
     *    0100 0110 0101 0111 1100 1110 1101 1111 (combine two results)
     *
     * 2. swap consecutive pairs
     *    v >> 2
     *    0001 0001 1001 0101 1111 0011 1011 0111 (move left consecutive pairs to right)
     *    0x33333333
     *    0011 0011 0011 0011 0011 0011 0011 0011 (mask to clear left consecutive pairs)
     *    (v >> 2) & 0x33333333
     *    0001 0001 0001 0001 0011 0011 0011 0011 (move left consecutive pairs to right, clear left consecutive pairs)
     *    v & 0x33333333
     *    0000 0010 0001 0011 0000 0010 0001 0011 (mask to clear left consecutive pairs)
     *    (v & 0x33333333) << 2
     *    0000 1000 0100 1100 0000 1000 0100 1100 (move right consecutive pairs to left, clear right consecutive pairs)
     *    0001 0001 0001 0001 0011 0011 0011 0011 (move left consecutive pairs to right, clear left consecutive pairs)
     *    (v >> 2) & 0x33333333 | (v & 0x33333333) << 2
     *    0001 1001 0101 1101 0011 1011 0111 1111 (combine two results)
     *
     * 3. swap nibbles
     *    1001 0001 1101 0101 1011 0011 1111 0111
     *
     * 4. swap bytes
     *    1101 0101 1001 0001 1111 0111 1011 0011
     *
     * 5. swap 2-byte long pairs
